...
from generate_property import output_property as output_property_oracle, onehotseq
from contributions_score_generative import contribution_score, train_importance_model
...
class Adalead():
    ...
    def _retrain_importance_model(self, measured_sequences):
        ...
        # print(self.initial_ohe.shape, measured_ohe.shape)
        # breakpoint()
    ...
    def propose_sequences(
        ...
        while track_queries < self.model_queries_per_batch:
            ...
            for i in range(0, len(parents), self.eval_batch_size):
                ...
                root_fitnesses = output_property_oracle(roots)
                ...
                # ):
                    ...
                    fitnesses = output_property_oracle(children)
