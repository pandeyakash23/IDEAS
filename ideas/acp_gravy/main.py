...
# Get the IDEAS root directory (two levels up from ideas/acp_gravy/)
...
sys.path.append(os.path.join(IDEAS_ROOT, 'datasets', 'acp_gravy'))
sys.path.append(os.path.join(IDEAS_ROOT, 'importance_models', 'acp_gravy'))
